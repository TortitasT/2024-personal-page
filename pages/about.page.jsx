  ...
  return (
    <main className="p-6 flex flex-col gap-3 max-w-xl text-justify mix-blend-exclusion">
      ...
      <p>
        ...
        <span class="text--nuxt">Nuxt.js</span>, {experience.laravel} years with{' '}
        <span class="text--laravel">Laravel</span> and {experience.aws} years
        with <span class="text--aws">AWS</span>.
      </p>
